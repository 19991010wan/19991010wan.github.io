    ...
    if (config) {
        ...
        if (config.work) {
            for (let i = 0; i < config.work.length; i++) {
                ...
                $(".paper-section .container").append(
                    "<div class=\"card\">\n" +
                    "    <div class=\"row\">\n" +
        ...
        if (config.award) {
            for (let i = 0; i < config.award.length; i++) {
        ...
        /*if (config.award) {
            for (let i = 0; i < config.award.length; i++) {
                ...
                let what = config.award[i][0];
                let desc = config.award[i][1];


                $(".award-section .container").append(
                    "<div class=\"card\">\n" +
                    "    <div class=\"row\">\n" +
                    "        <div class=\"col-md-3 bg-primary\" data-aos=\"fade-right\" data-aos-offset=\"50\"\n" +
                    "             data-aos-duration=\"500\">\n" +
